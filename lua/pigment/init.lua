...
function M.colorscheme()
	...
	set(0, "@markup.list", { fg = colors.italian_sky })
	set(0, "@markup.list.unchecked", { fg = colors.italian_sky })
	set(0, "markdownListMarker", { fg = colors.italian_sky })
	set(0, "@punctuation.special.markdown", { fg = colors.italian_sky })
	set(0, "ObsidianBullet", { fg = colors.italian_sky, bold = true })
	set(0, "ObsidianDone", { fg = colors.greek_green, bold = true })
	set(0, "ObsidianTilde", { fg = colors.russian_red, bold = true })
	set(0, "ObsidianRefText", { fg = colors.polish_red, underline = true })
